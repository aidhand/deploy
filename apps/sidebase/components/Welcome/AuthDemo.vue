...
<template>
  <div class="layout">
    <div class="group">
      ...
      <p class="description">
        Nuxt user authentication and sessions through nuxt-auth. nuxt-auth wraps
        NextAuth.js to offer the reliability & convenience of a 12k star library
        to the nuxt 3 ecosystem with a native developer experience (DX)
      </p>
    </div>
    <div class="group">
